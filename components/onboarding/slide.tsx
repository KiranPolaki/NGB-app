...
export default function Slide({
  ...
  useEffect(() => {
    // Animate card based on direction of navigation
    if (index >= totalSlides - 1) {
      // Sliding to last slide - animate card in from bottom
      translateY.value = height;
      translateY.value = withTiming(0, { duration: 500 });
    } else if (previousIndex >= totalSlides - 1) {
      // Navigating away from last slide - animate card out to bottom
